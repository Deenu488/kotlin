...
@ExportedBridge("__root___produce_nsviewcontroller")
public fun __root___produce_nsviewcontroller(): kotlin.native.internal.NativePtr {
    val _result = produce_nsviewcontroller()
    return _result.objcPtr()
}
